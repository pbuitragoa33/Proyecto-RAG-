...
def main():
    ...
    print(f"Guardados {len(df_chunks)} chunks en Datos_Modelos/Chunks/chunks_con_overlapping.parquet")
    ...
    print("Índice FAISS creado en Datos_Modelos/Indices/index_con_overlapping.faiss")
